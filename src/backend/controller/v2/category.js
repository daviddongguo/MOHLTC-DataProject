...
module.exports = {
	...
	addCategory: async (req, res, next) => {
		...
		if (category) {
			...
			return res.json({
				success: true,
				message: `Category (${id}, ${name}) saved.`,
			});
		}
	},
	...
	deleteCategory: async (req, res, next) => {
		...
		try {
			...
			res.json({
				success: true,
				result,
				message: `Removed ${result.deletedCount} category(s).`,
			});
		} catch (e) {
			next(e);
		}
	...
	categoryAssignGroups: async (req, res, next) => {
		...
		try {
			...
			res.json({
				success: true,
				result,
				message: `Updated ${result.modifiedCount} category(s).`,
			});
		} catch (e) {
			next(e);
		}
	...
	deleteCategoryGroup: async (req, res, next) => {
		...
		try {
			...
			res.json({
				success: true,
				message: `Removed category group ${doc.name} (${_id})`,
			});
		} catch (e) {
			next(e);
		}
